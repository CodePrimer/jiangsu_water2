...
def falseColor(inputPath,inputpath, outputDir):
    ...
    RgbComposite.Compose(inputpath, (2, 1, 11), noDataValue=0, returnMode='GEOTIFF', outputPath=falseColorTifPath,
...
def executeSql(modelUuid,chlaTifPath):
    ...
    if len(sqlRes) > 0:
        ...
        sqlData = (image_uuid, chlaTifName, db_path, 'tif', 'chla', 'Himawari-8', 'AHI', '30.8897', '120.66946', '119.8411',
