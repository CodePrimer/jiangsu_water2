...
def falseColor(inputPath,inputpath, outputDir):
    ...
    RgbComposite.Compose(inputpath, (1, 2, 1), noDataValue=0, returnMode='GEOTIFF', outputPath=falseColorTifPath,
...
def executeSql(modelUuid,chlaTifPath):
    ...
    if len(sqlRes) > 0:
        ...
        sqlData = (image_uuid, chlaTifName, db_path, 'tif', 'chla', 'AQUA', 'MODIS', '30.8897', '120.66946', '119.8411',
...
if __name__ == '__main__':
    ...
    # modelUuid = '3ce2dd0e-ee2d-11e9-b63f-0242ac110008'
