...
def sdd(inPath,taihuPath,cloudPath, outPath):
    ...
    sddArray = np.where(sddArray > 2, sddArray * 0.038 + 1.92, sddArray)
...
def falseColor(inputPath,inputpath,outputDir):
    ...
    RgbComposite.Compose(inputpath,(2,1,4),noDataValue=0,returnMode='GEOTIFF',\
...
def executeSql(modelUuid,sddTifPath):
    ...
    if len(sqlRes) > 0:
        ...
        sqlData=(image_uuid,chlaTifName,db_path, 'tif','sdd','GOCI','COMS','30.8897','120.66946','119.8411','31.58009',\
