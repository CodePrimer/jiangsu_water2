...
def executeSql(modelUuid,tssTifPath):
    ...
    cursor = conn.cursor()
    tssTifName = os.path.basename(tssTifPath)
    issue=tssTifName.split('_')[3]
    sqlData = (modelUuid, tssTifName)
    ...
    if len(sqlRes) > 0:
        ...
        sqlData=(image_uuid,tssTifName,db_path, 'tif','tss','Himawari-8','AHI','30.8897','120.66946','119.8411','31.58009',\
