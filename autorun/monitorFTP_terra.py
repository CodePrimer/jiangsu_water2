...
import preprocess.preprocess_modis250_terra
...
def main():
    ...
    for hhmm in hhmmList:
        ...
        if modisFiles['MOD03'] and modisFiles['MOD02QKM']:
            ...
            processOutputName = 'TERRA_MODIS_L2_%s_250_00_00.tif' % issue
            ...
            preprocess.preprocess_modis250_terra.mod02qkmToTif(modisFiles['MOD02QKM'], modisFiles['MOD03'], processOutputPath)
...
if __name__ == '__main__':
    ...
    # # 测试数据
    # modisFiles = {
    #     'MOD02QKM': r'C:\Users\Administrator\Desktop\model\ftpdownload\MODIS\TERRA_X_2020_10_13_10_26_D_G.MOD02QKM.hdf',
    #     'MOD03': r'C:\Users\Administrator\Desktop\model\ftpdownload\MODIS\TERRA_X_2020_10_13_10_26_D_G.MOD03.hdf'}
    # # 调用预处理
    # issue = ''.join(modisFiles['MOD03'].split('_')[2:7]) + '00'
    # processOutputName = 'TERRA_MODIS_250_L2_%s_061_00.tif' % issue
    # processOutputPath = os.path.join(globalCfg['input_path'], 'satellite', 'EOS-MODIS-250', processOutputName)
    # if os.path.exists(processOutputPath):
    #     os.remove(processOutputPath)
    # terra_preprocess(modisFiles['MOD02QKM'], modisFiles['MOD03'], processOutputPath)
    #
    # # 调用产品
